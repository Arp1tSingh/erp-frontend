...
import { GraduationCap, LogOut, Users, BarChart3, BookOpen } from "lucide-react";
      ...
      default:
        return (
          <div className="space-y-8">
            <div>
              <h2 className="mb-2">Welcome, {adminName}</h2>
            ...
            <div className="grid md:grid-cols-4 gap-6">
              ...
              <Card className="flex flex-col justify-center">
                <CardHeader>
                  ...
                  <p className="text-muted-foreground">Full & part-time</p>
                </CardHeader>
              </Card>
              <Card className="flex flex-col justify-center">
                <CardHeader>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-4 pb-4 border-b">
                    ...
                    <div className="flex-1">
                      <p>New student enrollment: Sarah Johnson</p>
                  ...
                  <div className="flex items-center gap-4 pb-4 border-b">
                    ...
                    <div className="flex-1">
                      <p>Course "Advanced Physics" updated</p>
                  ...
                  <div className="flex items-center gap-4 pb-4 border-b">
                    ...
                    <div className="flex-1">
                      <p>Attendance report generated for October</p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <p>Grade submission deadline: October 15</p>
